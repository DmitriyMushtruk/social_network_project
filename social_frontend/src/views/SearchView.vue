        ...
        <div class="main-left col-span-3 space-y-4">
            ...
            <div class=" p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4">
                <div class="p-4 text-center bg-gray-100 rounded-lg">
                    <img src="https://i.pravatar.cc/300?img=26" class="mb-6 rounded-full">

                    <p><strong>Maria Stein</strong></p>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <img src="https://i.pravatar.cc/300?img=42" class="w-[40px] rounded-full">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente molestiae necessitatibus, dolores esse tenetur unde vero quisquam alias, libero nisi consequuntur eaque, aut porro sunt eveniet vitae? Suscipit, et sunt!</p> 
